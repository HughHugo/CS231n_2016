...
def affine_relu_backward(dout, cache):
    """
    Backward pass for the affine-relu covenience layer.
    """
...
def affine_bn_relu_forward(x, w, b, gamma, beta, bn_param):
    """
    Convenience layer that performs an {affine - batchnorm - ReLU} transformation.
    
    Inputs:
    - x: Input to the affien layer
    - w, b: Weights and biases for the affine layer
    - gamma, beta: Scale and shift paramter for the batch normalization layer
...
def conv_relu_pool_backward(dout, cache):
    """
    Backward pass for the conv-relu-pool convenience alyer
    """
